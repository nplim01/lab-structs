...
var favoriteBook = Book(title: "Harry Potter", author: "J.K Rowling", pages: 720, price: 22.32)
print ("My favorite book is \(favoriteBook.title), by \(favoriteBook.author), which has \(favoriteBook.pages) pages, and costs $\(favoriteBook.price).")
...
print (Height.init(Centimeters: 254))
